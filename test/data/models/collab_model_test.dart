...
void main() {
  final testCollab =
      CollabModel(name: 'test', lastName: 'lastName', email: 'email@email.com');
  final testCollabWithoutLastName =
      CollabModel(name: 'test', lastName: '', email: 'email@email.com');
  ...
  group("fromGson", () {
    test('should return a valid model when the last name is not available',
        () async {
